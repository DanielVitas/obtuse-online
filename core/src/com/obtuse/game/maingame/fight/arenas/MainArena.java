...
public class MainArena extends Arena {

    public MainArena(FightGame fightGame, Array<Hero> heroes, Array<Enemy> enemies) {
        super(fightGame);
        clear();
        ...
        link(enemyHolders.get(0), enemyHolders.get(1));
        link(enemyHolders.get(0), enemyHolders.get(3));
        link(enemyHolders.get(1), enemyHolders.get(2));
        link(enemyHolders.get(1), enemyHolders.get(4));
        link(enemyHolders.get(2), enemyHolders.get(5));
        link(enemyHolders.get(3), enemyHolders.get(4));
        link(enemyHolders.get(4), enemyHolders.get(5));
    ...
    protected float[] setEnemyPositions() {
        return new float[]{
                1f, Obtuse.cameraWidth / Obtuse.ratio * 0.7f,
                1f, Obtuse.cameraWidth / Obtuse.ratio * 0.55f,
                1f, Obtuse.cameraWidth / Obtuse.ratio * 0.4f,
                2.5f, Obtuse.cameraWidth / Obtuse.ratio * 0.7f,
                2.5f, Obtuse.cameraWidth / Obtuse.ratio * 0.55f,
                2.5f, Obtuse.cameraWidth / Obtuse.ratio * 0.4f
        };
    }
