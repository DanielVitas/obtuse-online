...
public class TripleBossArena extends Arena {

    public TripleBossArena(FightGame fightGame, Array<Hero> heroes, Array<Enemy> enemies) {
        super(fightGame);
        clear();
        ...
        link(enemyHolders.get(0), enemyHolders.get(2));
    ...
    protected float[] setEnemyPositions() {
        return new float[]{
                ...
                3f, Obtuse.cameraWidth / Obtuse.ratio * 0.35f,
                3f, Obtuse.cameraWidth / Obtuse.ratio * 0.65f
        };
    }
